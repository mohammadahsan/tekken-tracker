...
class StageCreator {
    ...
    async singleElimination() {
        var _a, _b, _c, _d;
        if (!((_a = this.stage.settings) === null || _a === void 0 ? void 0 : _a.manualOrdering) && Array.isArray((_b = this.stage.settings) === null || _b === void 0 ? void 0 : _b.seedOrdering) &&
            ((_c = this.stage.settings) === null || _c === void 0 ? void 0 : _c.seedOrdering.length) !== 1)
            throw Error('You must specify one seed ordering method.');
        let ordered;
        if ((_d = this.stage.settings) === null || _d === void 0 ? void 0 : _d.manualOrdering) {
            ...
            ordered = ordering_1.ordering[method](slots);
        }
        const stage = await this.createStage();
    ...
    async doubleElimination() {
        var _a, _b, _c;
        if (!((_a = this.stage.settings) === null || _a === void 0 ? void 0 : _a.manualOrdering) && this.stage.settings && Array.isArray(this.stage.settings.seedOrdering) &&
        ...
        const stage = await this.createStage();
        if ((_c = this.stage.settings) === null || _c === void 0 ? void 0 : _c.skipFirstRound)
    ...
    async createMatch(stageId, groupId, roundId, matchNumber, opponents, childCount) {
        ...
        if (this.updateMode) {
            ...
            if (existing) {
                ...
                if (existingStatus > status && existingStatus >= brackets_model_1.Status.Running)
