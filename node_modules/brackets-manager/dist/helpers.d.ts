import { GrandFinalType, Match, MatchGame, MatchResults, Participant, ParticipantResult, Result, RoundRobinMode, Seed, Seeding, SeedOrdering, Stage, StageType, Status, GroupType, Id, RankingItem, RankingFormula } from 'brackets-model';
 ...
 */
export declare function mapParticipantsNamesToDatabase(seeding: Seeding, database: Participant[], positions?: Seed[]): ParticipantSlot[];
/**
 ...
 * @param positions An optional list of positions (seeds) for a manual ordering.
 */
export declare function mapParticipantsIdsToDatabase(seeding: Seeding, database: Participant[], positions?: Seed[]): ParticipantSlot[];
/**
 ...
 * @param positions An optional list of positions (seeds) for a manual ordering.
 */
export declare function mapParticipantsToDatabase(prop: 'id' | 'name', seeding: Seeding, database: Participant[], positions?: Seed[]): ParticipantSlot[];
/**
